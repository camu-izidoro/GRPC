...
ini1 = time.time()
channel1 = grpc.insecure_channel('192.168.0.17:7070')
...
ini2 = time.time()
channel2 = grpc.insecure_channel('192.168.0.17:7070')
...
ini3 = time.time()
channel3 = grpc.insecure_channel('192.168.0.17:7070')
...
ini5= time.time()
channel5 = grpc.insecure_channel('192.168.0.17:7070')
...
ini6= time.time()
channel6 = grpc.insecure_channel('192.168.0.17:7070')
...
ini7= time.time()
channel7 = grpc.insecure_channel('192.168.0.17:7070')
...
channel8 = grpc.insecure_channel('192.168.0.17:7070')
...
ini4 = time.time()
channel4 = grpc.insecure_channel('192.168.0.17:7070')
